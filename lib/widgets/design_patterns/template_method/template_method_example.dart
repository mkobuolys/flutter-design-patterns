    ...
    return const ScrollConfiguration(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            StudentsSection(bmiCalculator: StudentsXmlBmiCalculator(), headerText: 'Students from XML data source:'),
            SizedBox(height: LayoutConstants.spaceL),
            StudentsSection(bmiCalculator: StudentsJsonBmiCalculator(), headerText: 'Students from JSON data source:'),
            SizedBox(height: LayoutConstants.spaceL),
            StudentsSection(
